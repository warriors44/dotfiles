...
export PBS_SERVER=ryzen1
# source ~/miniforge3/etc/profile.d/conda.sh  # commented out by conda initialize
# source ~/miniforge3/bin/activate  # commented out by conda initialize
export PATH="/home/shinya1944/bin:$PATH"
export PATH=/opt/singularity/bin:$PATH

export AMBERHOME=$HOME/apps/amber24
export PATH=$AMBERHOME/bin:$PATH
alias amber='source /home/shinya1944/apps/amber24/amber.sh'


# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/shinya1944/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/shinya1944/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/home/shinya1944/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/home/shinya1944/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/home/shinya1944/miniforge3/etc/profile.d/mamba.sh" ]; then
    . "/home/shinya1944/miniforge3/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<

export PATH=/home/shinya1944/apps/pbs/bin:$PATH
